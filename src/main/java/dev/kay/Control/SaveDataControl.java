...
public final class SaveDataControl {
    ...
    //TODO write method
    public static void saveCustomerList(CustomerList customerList){
        try{
            BufferedWriter bufferedWriter = new BufferedWriter(new FileWriter("src\\file\\CustomerList.txt"));
            for(int i=0; i< customerList.getPersonArrayList().size(); i++){
                Customer customer = (Customer) customerList.getPersonArrayList().get(i);
